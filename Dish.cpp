 ...
 * It also includes an Ingredient default and parameterized constructor.
...
Ingredient::Ingredient() : name("UNKNOWN"), quantity(0), required_quantity(0), price(0.0) {}

Ingredient::Ingredient(const std::string& name, int quantity, int required_quantity, double price) : name(name), quantity(quantity), required_quantity(required_quantity), price(price) {}
